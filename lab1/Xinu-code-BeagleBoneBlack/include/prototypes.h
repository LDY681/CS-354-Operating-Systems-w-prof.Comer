...
/* in file limit.c */
extern	syscall	tlimit(pid32 id, int16 limit);
...
/* in file printer.c */
extern syscall type(char);
extern syscall kerneltype(char);
extern syscall print(char);
extern syscall kernelprint(char);
